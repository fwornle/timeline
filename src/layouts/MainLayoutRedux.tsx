...
const MainLayoutRedux: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  // Create route props for backward compatibility
  const routeProps = {
    repoUrl,
    ...
    autoDrift,
    setAutoDrift: handleAutoDriftChange,
    droneMode,
    setDroneMode: handleDroneModeToggle,
    gitCount,
    specCount,
    isLoading,
    isGitHistoryMocked,
    ...
    setCameraPosition,
    cameraState,
    setCameraState: handleCameraStateChange,
    forceReloadFlag,
    setForceReloadFlag,
    viewAllMode,
    setViewAllMode: handleViewAllToggle,
    focusCurrentMode,
    setFocusCurrentMode: handleFocusCurrentModeChange,
    debugMode,
    setDebugMode: handleDebugModeChange,
    timelineStartDate,
    ...
    timelineLength,
    setTimelineLength,
    onTimelineDataFetch: handleTimelineDataFetch,
  };

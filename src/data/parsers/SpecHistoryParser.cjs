 ...
 * @param {string} content The content of the spec history file
 * @returns {Object} Statistics about the spec history
 */
function parseSpecHistoryStats(content) {
  // Initialize stats
  const stats = {
    promptCount: 0,
    filesCreated: 0,
 ...
 * @param {string[]} responseLines Lines of the assistant's response
 * @returns {Object} Statistics for this response
 */
function parseAssistantResponse(responseLines) {
  const stats = {
    filesCreated: 0,
    filesModified: 0,
    linesAdded: 0,
